...
Goal: Produce an escalation-ready ITSM/DevOps plan and decision-tree for **SRE/DevOps SEV1 Triage with Platform L4 Escalation Readiness** that drives a severe outage/problem/change toward mitigation and root cause with L3/L4-quality documentation.
